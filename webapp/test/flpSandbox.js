		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Daily Huddle ",
									"targetURL": "#DailyHuddledailyhuddleapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DailyHuddledailyhuddleapp-display": {
								"semanticObject": "DailyHuddledailyhuddleapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=DailyHuddle.dailyhuddleapp",
									"url": sap.ui.require.toUrl("DailyHuddle/dailyhuddleapp")
								}
							}
						}
					}
